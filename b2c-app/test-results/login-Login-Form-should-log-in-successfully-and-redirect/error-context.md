...
- Name: Login Form >> should log in successfully and redirect
- Location: C:\B2C-Store-Application\b2c-app\e2e\login.spec.ts:38:7
...
Call log:
  - waiting for getByRole('button', { name: 'Log in' })
    ...
    at C:\B2C-Store-Application\b2c-app\e2e\login.spec.ts:42:56
```
...
- text: Email
- textbox "Email": adminaccount@gmail.com
- text: Password
- textbox "Password": b2cadmin
- paragraph:
